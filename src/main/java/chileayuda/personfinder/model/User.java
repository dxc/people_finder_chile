...
import chileayuda.personfinder.utils.ShaUtils;
...
public class User {
    ...
    public void update( ModelPeopleFinder modelUser, User updated) throws PeopleFinderException {
    ...
    static public User fromJson(JSONObject userJson) throws PeopleFinderException {
        return fromJson(userJson, false);
    }

    static public User fromJson(JSONObject userJson, boolean update) throws PeopleFinderException {
        // TODO: Whether empty fields should be null or empty strings
        if (!userJson.has("id") && !update)
            throw new PeopleFinderException("User id is missing");
