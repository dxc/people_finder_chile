...
package chileayuda.personfinder.utils;
...
public class NameValueList<T> implements Iterable<NameValue<T>> {
    ...
    public NameValue<T> add(String name, T value) throws PeopleFinderException {
    ...
    public NameValue<T> put(String stringName, NameValue<T> value) throws PeopleFinderException {
        ...
        if (containsKey(stringName)) {
            ...
            if (i < 0)
                throw new PeopleFinderException("Corrupted nameValueList for key: '" + stringName + "'");
    ...
    public NameValue<T> put(String stringName, T value)
            throws PeopleFinderException {
        return put(stringName, new NameValue<T>(stringName, value));
    }

    public NameValue<T> put(String stringName, String value) throws PeopleFinderException {
