...
import chileayuda.personfinder.utils.value.*;
...
public class JsonUtils {
    ...
    public static void validateKeys(JSONObject objectJson, String objectName, List<String> validKeys) throws PeopleFinderException {
        String badKeys = "";
        ...
        if (badKeys.length() > 0)
            throw new PeopleFinderException(objectName + " JSON has invalid keys: " + badKeys);
    }
