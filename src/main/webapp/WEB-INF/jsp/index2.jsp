                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="code">
                                            <div class="container">
                                                <div class="line number1 index0 alt0"><code class="jscript plain">{</code></div>
                                                <div class="line number2 index1 alt1"><code class="jscript plain"> "person_record_id": "test-people-1",</code></div>
                                                <div class="line number3 index2 alt2"><code class="jscript plain"> "full_name": "test-people-name"</code></div>
                                                <div class="line number4 index3 alt3"><code class="jscript plain">}</code></div>
                                                <div> <u>Datos soportados: </u></div>
                                                <div class="line number5 index4 alt4"><code class="jscript string"> (person_record_id, full_name, entry_date, expiry_date, author_name, author_email,
                                                </code></div>
                                                <div class="line number6 index5 alt5"><code class="jscript string"> source_name, source_date, source_url, given_name,
                                                </code></div>
                                                <div class="line number7 index6 alt6"><code class="jscript string"> family_name, alternate_names,  sex,photo_url
                                                </code></div>
                                                <div class="line number8 index7 alt7"><code class="jscript string"> age,  home_street,  home_city,description)
                                                </code></div>
